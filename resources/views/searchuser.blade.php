    ...
    <div class="filter-bar">
        <form action="" class="d-flex w-100">
            <div class="filter-input-wrap">
                ...
                <input type="text" placeholder="Filter users by name, email...">
            </div>
            ...
            <tbody>
                @foreach ($searched as $user )
                    <tr>
                        ...
                        <td><span class="status-cell"><span class="status-dot {{$user->status == 'active' ? 'active' : ''}}"></span>{{ucwords($user->status)}}</span></td>
                        ...
                        <td class="align-center">
                            <div class="d-flex">
                                ...
                                <button class="card-action-btn delete" title="Delete"><i class="bi bi-trash"></i></button>
                            </div>
                        </td>
                    </tr>
                @endforeach
